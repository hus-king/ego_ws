...
tmux send-keys -t ros_session:0.2 'sleep 5; roslaunch complete_mission ego_planner_mid360.launch' C-m

# Pane 3: 激光雷达坐标转换
tmux split-window -v -t ros_session:0.0
tmux send-keys -t ros_session:0.3 'sleep 6; rosrun complete_mission laser_to_worldframe' C-m
...
tmux send-keys -t ros_session:1.1 'sleep 7; roslaunch complete_mission ego_planner.launch' C-m
